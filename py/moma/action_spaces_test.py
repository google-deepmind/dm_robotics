...
from dm_robotics.agentflow import action_spaces as af_action_spaces
...
class CompositeActionSpaceTest(absltest.TestCase):
  ...
  def test_single_action_space(self):
    ...
    primitive = af_action_spaces.prefix_slicer(outer_spec, "a_")
  ...
  def test_adjacent_action_spaces_full(self):
    ...
    primitive_1 = af_action_spaces.prefix_slicer(outer_spec, "a_")
    primitive_2 = af_action_spaces.prefix_slicer(outer_spec, "b_")
  ...
  def test_composite_action_spaces(self):
    ...
    primitive_1 = af_action_spaces.prefix_slicer(outer_spec, "a")
    primitive_2 = af_action_spaces.prefix_slicer(outer_spec, "c")
    primitive_3 = af_action_spaces.prefix_slicer(outer_spec, "d")
    primitive_4 = af_action_spaces.prefix_slicer(outer_spec, "f")
  ...
  def test_zero_sized_space(self):
    ...
    outer_spec = self._create_spec("a_1", "a_2", "b_1", "b_2")
    primitive_1 = af_action_spaces.prefix_slicer(outer_spec, "a_")
    primitive_2 = af_action_spaces.prefix_slicer(outer_spec, "EMPTY")
    primitive_3 = af_action_spaces.prefix_slicer(outer_spec, "b_")
    composite = action_spaces.CompositeActionSpace(
  ...
  def test_with_fixed_space(self):
    ...
    fixed_2 = af_action_spaces.FixedActionSpace(primitive_2, value_2)
