...
#ifndef DM_ROBOTICS_SUPPORT_LOGGING_H_
#define DM_ROBOTICS_SUPPORT_LOGGING_H_
...
// Terminates the program if `ptr` is null. Returns the same object otherwise.
template <typename T>
T* DieIfNull(T* ptr) {
  CHECK(ptr != nullptr);
  return ptr;
...
#endif  // DM_ROBOTICS_SUPPORT_LOGGING_H_
